...
const projectsData: Project[] = [
  {
    ...
    Github:- [Link](https://github.com/sarthakkapila/Kairos)`,
  ...
  },
  {
    title: 'VeriTiny',
    description: `
        🛠️ Minimal CPU implementation in SystemVerilog


        Aimed at learning how CPUs & GPUs work from the ground up!

        Will make the repo public soon!  (Under Construction🔨)
    `,
...
This powerful tool propagates code changes seamlessly across your codebase`,
...

  {
    ...
    Github:- [Link](https://github.com/sarthakkapila/Notionclone)`,
  ...
  },
  {
    ...
    Github:- [Link](https://github.com/sarthakkapila/Miniprop),
    📊🤖`,
